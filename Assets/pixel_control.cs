...
public class pixel_control : MonoBehaviour
{
    ...
    public void get_set_pixels(Color[] shape, Color[] from, Color[] to, int x, int y, int width, int height, int from_width)
    {
    ...
    public void kill_by_sub_texture_shape_world_pos(float x, float y, int s_width, int s_height, int x_off, int y_off, Texture2D shape)
    {
        ...
        kill_by_sub_texture_shape(p_x, p_y, s_width, s_height, x_off, y_off, shape);
    }
	 ...
	 * use world to pixel before calling this
	 */
    public void kill_by_sub_texture_shape(int x, int y, int s_width, int s_height, int x_off, int y_off, Texture2D shape)
    {
        ...
        kill_by_texture_shape(x, y, s_width, s_height, c_shape);
    }


    public void kill_by_texture_shape(int x, int y, Texture2D shape)
    {
        int down_out_offset = 0;
        int left_out_offset = 0;
	 ...
	 * use world to pixel before calling this
	 */
    public void kill_by_texture_shape(int x, int y, int s_width, int s_height, Color[] c_shape)
    {
        get_set_pixels(c_shape, bg_colors, bg_colors_temp, b_l.x, b_l.y, s_width, s_height, bg_width);
